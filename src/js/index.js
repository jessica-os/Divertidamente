...
function alterarBolhaPersonagem(personagem) {
  ...
  const raiva = document.getElementById("raiva").addEventListener("mouseenter", () => {
  ...
  const alegria = document.getElementById("alegria").addEventListener("mouseenter", () => {
    bolhasMedo.style.display = "none";
    bolhasTristeza.style.display = "none";
    bolhasNojinho.style.display = "none";
  ...
  const nojinho = document.getElementById("nojinho").addEventListener("mouseenter", () => {
    bolhasMedo.style.display = "none";
    bolhasTristeza.style.display = "none";
    bolhasRaiva.style.display = "none";
    bolhasAlegria.style.display = "none";
  ...
  const tristeza = document.getElementById("tristeza").addEventListener("mouseenter", () => {
    bolhasMedo.style.display = "none";
    bolhasRaiva.style.display = "none";
    bolhasAlegria.style.display = "none";
    bolhasNojinho.style.display = "none";
  ...
  const medo = document.getElementById("medo").addEventListener("mouseenter", () => {
    bolhasRaiva.style.display = "none";
    bolhasAlegria.style.display = "none";
    bolhasNojinho.style.display = "none";
    bolhasTristeza.style.display = "none";
